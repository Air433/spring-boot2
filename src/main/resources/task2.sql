...
CREATE TABLE `sys_role_permission` (
  ...
  `permission_id` int(11) NOT NULL COMMENT '权限主键编号',
...
CREATE TABLE `sys_permission` (
  `permission_id` int(11) NOT NULL COMMENT '权限主键编号',
  `permission_key` varchar(1000) DEFAULT NULL COMMENT '权限编码',
   `authority_id` bigint(20) COMMENT '菜单编号',
  KEY `FK9q28ewrhjikj3kh1be7` (`permission_id`),
